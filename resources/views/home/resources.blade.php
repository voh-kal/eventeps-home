...
<section class="bg-light">
    ...
    <div class="container">
                ...
                <div class="box pl-3 row_bg">
                    <div class="card card_pad">
                        <div style="height: 300px;border-radius: inherit;">
                            <img class="img_clip1 img-fluid" src="{{env('TEPS')}}/storage/assets/images/{{$all->image}}" alt="" style="border-radius: inherit; width:100%">
        ...
        <div class="d-flex col-md-3 pb-4 mx-auto">
