...
<body class="home">
    <style>
        ...
        #navigation {
            background: linear-gradient(238deg, rgba(59, 200, 221, 1) 2%, rgba(47, 142, 236, 1) 68%);
        }
        ...
        .navi a {
            border-bottom: 1px solid #2f8feb;
            border-top: 1px solid #3090ec;
            color: #ffffff;
            display: block;
            font-size: 17px;
            font-weight: 500;
    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="logo">
                    <a href="/"><img src="/img/white.png" alt="logo" class="hidden-xs hidden-sm" style="width: 80px;">
                        <img src="/images/white.png" alt="logo" class="visible-xs visible-sm circle-logo" style="width: 39%;">
                    </a>
                </div>
                <div class="navi">
                    <ul>
                        <li><a href="/register"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Home</span></a></li>
